          ...
          ${isDarkMode
            ...
            <div className="flex gap-4 flex-wrap">
                ...
                {password && (
                    <button
                        onClick={() => {
                            isPremium ? setShowLabelInput(true) : setShowPremiumPrompt(true);
                        }}
                        className={`px-4 py-2 rounded-3xl transition 
              ${isPremium ? "bg-yellow-500 text-black hover:bg-yellow-600" : "bg-gray-400 text-white"}`}
                    >
                        Save with Label
                    </button>
                )}
            ...
            {showPremiumPrompt && !isPremium && (
                <div className="mt-6 bg-yellow-100 text-black p-4 rounded-xl shadow-inner text-center">
                    <h3 className="text-lg font-semibold mb-2">Upgrade to Premium</h3>
                    <p className="text-sm mb-4">Saving with label is a premium feature. Please upgrade your plan to unlock it.</p>
                    <a
                        href="/subscribe"
                    ...
                    <button
                        ...
                        className="mt-2 block text-xs text-gray-500 underline hover:text-gray-700 mx-auto"
                    >
                        Maybe later
                    </button>
                </div>
